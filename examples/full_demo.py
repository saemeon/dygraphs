...
chart1_component = DygraphChart(figure=chart1, id="chart-1", height="320px")
...
chart2_component = DygraphChart(figure=chart2, id="chart-2", height="320px")
...
chart3_component = DygraphChart(figure=chart3, id="chart-3", height="250px")

# ---------------------------------------------------------------------------
# Chart 4: Stacked bar chart with range selector
# ---------------------------------------------------------------------------

chart4_component = StackedBarChart(
    id="chart-4",
...
chart5_component = DygraphChart(figure=chart5, id="chart-5", height="280px")
...
chart6_component = DygraphChart(figure=chart6, id="chart-6", height="200px")
...
chart7_component = DygraphChart(figure=chart7, id="chart-7", height="280px")
...
chart8_component = DygraphChart(figure=chart8, id="chart-8", height="250px")
...
chart9_component = DygraphChart(figure=chart9, id="chart-9", height="250px")
...
chart10_component = DygraphChart(figure=chart10, id="chart-10", height="280px")
...
chart11_component = DygraphChart(figure=chart11, id="chart-11", height="280px")
...
chart12_component = DygraphChart(figure=chart12, id="chart-12", height="280px")
...
chart13_component = DygraphChart(figure=chart13, id="chart-13", height="250px")
...
chart14_component = DygraphChart(figure=chart14, id="chart-14", height="250px")
...
chart15_component = DygraphChart(figure=chart15, id="chart-15", height="250px")
